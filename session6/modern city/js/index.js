...
function setupThreeJS() {
  ...
  renderer.setClearColor(0xf9f1c2, 1);
...
function setupWorld() {
  ...
  var mat = new THREE.MeshPhongMaterial({color: 0xffc0cb, overdraw: true});
  ...
  for (var i = 0; i < 200; i++) {
    ...
    building.scale.y  = Math.pow(Math.random(), 3) * 50 + 10;
    building.scale.z  = Math.pow(Math.random(), 2) * 50 + 10;
